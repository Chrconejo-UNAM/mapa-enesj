...
async def add_security_headers(request: Request, call_next):
    ...
    response.headers["Content-Security-Policy"] = "default-src 'self'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data:; frame-ancestors 'none';"
...
pos = {
    ...
    'Baños 1 sótano': (9, 0), 'Baños 2 sótano': (51, 0.875),
    'Auditorio': (1, 0.5), 'Entrada': (16, 0.75), 'Recepción': (20, 1),
    'Baños 1 planta baja': (9, 0.625), 'Baños 2 planta baja': (25, 1.125), 'Baños 3 planta baja': (51, 1.375),
    'Vitrinas': (31, 1), 'VI-PB01': (38, 1.25), 'Microondas': (36, -0.5),
    'VI-PB02': (41, 1.25), 'VI-PB03': (44, 1.25), 'VI-PB04': (47, 1.25),
    'Nutrición': (38, 1), 'Médico': (40, 1), 'Lactancia': (42, 1),
    'Psicopedagogía': (44, 1), 'CID planta baja': (46, 1),
    'Entrada estacionamiento': (33, -0.75), 'Canchas': (50, -0.5), 'Mini circuito': (53.5, 0),
    'Escaleras 1 piso 1': (7, 1.125), 'Escaleras 2 piso 1': (26, 1.8), 'Escaleras 3 piso 1': (50, 1.8),
    'Baños 1 piso 1': (9, 1.375), 'Baños 2 piso 1': (27, 1.9), 'Baños 3 piso 1': (51, 1.9),
    'IV-101': (13, 1.275), 'IV-102': (18.2, 1.5), 'IV-103': (22, 1.7),
    'V-101': (31, 1.8), 'V-102': (34, 1.8), 'Ajedrez': (44, 1.8), 'CID piso 1': (45, 1.5),
    'Escaleras 1 piso 2': (7, 1.8), 'Escaleras 2 piso 2': (26, 2.30), 'Escaleras 3 piso 2': (50, 2.45),
    ...
    'Baños 1 piso 2': (9, 1.95), 'Baños 2 piso 2': (27, 2.45), 'Baños 3 piso 2': (51, 2.55),
    'Escaleras 1 piso 3': (7, 2.3), 'Escaleras 2 piso 3': (26, 2.9), 'Escaleras 3 piso 3': (50, 3),
    ...
    'CID piso 3': (45, 2.75), 'Baños 1 piso 3': (9, 2.45), 'Baños 2 piso 3': (27, 3.1), 'Baños 3 piso 3': (51, 3.15),
    'Escaleras 1 piso 4': (7, 3), 'Escaleras 2 piso 4': (26, 3.5), 'Escaleras 3 piso 4': (50, 3.5),
    'Zona de docentes 1': (3, 3), 'Zona de docentes 2': (14, 3.2), 'Zona de docentes 3': (17, 3.3), 'Zona de docentes 4': (20, 3.4), 'Zona de docentes 5': (22, 3.45),
    'V-401': (29, 3.5), 'V-402': (31, 3.5), 'V-403': (33, 3.5), 'V-404': (35.5, 3.5),
    'VI-401': (38, 3.5), 'VI-402': (41, 3.5), 'VI-403': (44, 3.5), 'VI-404': (47, 3.5),
    'CID piso 4': (42.7, 3.25), 'Baños 1 piso 4': (9, 3.2), 'Baños 2 piso 4': (27, 3.65), 'Baños 3 piso 4': (51, 3.65),
    'Escaleras 1 piso 5': (7, 3.6), 'Escaleras 2 piso 5': (26, 4), 'Escaleras 3 piso 5': (50, 4),
    'Paneles solares': (0, 3.7), 'Jardineras': (32, 3.9), 'Gym al aire libre': (39, 3.9),
