...
pos = {
    ...
    'Escaleras 1 piso 1': (7, 1.125), 'Escaleras 2 piso 1': (26, 1.8), 'Escaleras 3 piso 1': (50, 1.8), 'Baños 1 piso 1': (9, 1.375), 'Baños 2 piso 1': (27, 1.9), 'Baños 3 piso 1': (51, 1.9), 'IV-101': (13, 1.275), 'IV-102': (18.2, 1.5), 'IV-103': (22, 1.7), 'V-101': (31, 1.8), 'V-102': (34, 1.8), 'Ajedrez': (44, 1.8), 'CID piso 1': (45, 1.5),
    'Escaleras 1 piso 2': (7, 1.8), 'Escaleras 2 piso 2': (26, 2.30), 'Escaleras 3 piso 2': (50, 2.45), 'III-201': (-4, 1.75), 'III-202': (-1.5, 1.75), 'Secretaría administrativa': (4, 1.8), 'Secretaría académica': (12, 1.95), 'Secretaría general': (15, 2.05), 'Sala de juntas': (19, 2.15), 'Dirección': (22, 2.25), 'Secretaría de educación y vinculación': (30, 2.45), 'Servicios escolares': (34, 2.45), 'VI-201': (38, 2.45), 'VI-202': (41, 2.45), 'VI-203': (44, 2.45), 'VI-204': (47, 2.45), 'Baños 1 piso 2': (9, 1.95), 'Baños 2 piso 2': (27, 2.45), 'Baños 3 piso 2': (51, 2.55),
    'Escaleras 1 piso 3': (7, 2.3), 'Escaleras 2 piso 3': (26, 2.9), 'Escaleras 3 piso 3': (50, 3), 'III-301': (-4, 2.3), 'III-302': (-1.5, 2.3), 'III-303': (1, 2.3), 'III-304': (4.5, 2.3), 'IV-301': (12, 2.5), 'IV-302': (15, 2.60), 'IV-303': (17, 2.65), 'IV-304': (20, 2.72), 'IV-305': (22, 2.8), 'V-301': (29, 3), 'V-302': (31, 3), 'V-303': (33, 3), 'V-304': (35.5, 3), 'VI-301': (38, 3), 'VI-302': (41, 3), 'VI-303': (44, 3), 'VI-304': (47, 3), 'CID piso 3': (45, 2.75), 'Baños 1 piso 3': (9, 2.45), 'Baños 2 piso 3': (27, 3.1), 'Baños 3 piso 3': (51, 3.15),
    'Escaleras 1 piso 4': (7, 3), 'Escaleras 2 piso 4': (26, 3.5), 'Escaleras 3 piso 4': (50, 3.5), 'Zona de docentes 1': (3, 3), 'Zona de docentes 2': (14, 3.2), 'Zona de docentes 3': (17, 3.3), 'Zona de docentes 4': (20, 3.4), 'Zona de docentes 5': (22, 3.45), 'V-401': (29, 3.5), 'V-402': (31, 3.5), 'V-403': (33, 3.5), 'V-404': (35.5, 3.5), 'VI-401': (38, 3.5), 'VI-402': (41, 3.5), 'VI-403': (44, 3.5), 'VI-404': (47, 3.5), 'CID piso 4': (42.7, 3.25), 'Baños 1 piso 4': (9, 3.2), 'Baños 2 piso 4': (27, 3.65), 'Baños 3 piso 4': (51, 3.65),
    'Escaleras 1 piso 5': (7, 3.6), 'Escaleras 2 piso 5': (26, 4), 'Escaleras 3 piso 5': (50, 4), 'Paneles solares': (0, 3.7), 'Jardineras': (20, 3.9), 'Gym al aire libre': (39, 3.9), 'Baños 1 piso 5': (9, 3.85), 'Baños 2 piso 5': (31, 4.2)
}
...
def trazar_ruta(peticion: PeticionRuta):
    try:
        ...
        for u, v in zip(ruta, ruta[1:]):
            ...
            draw.line([(x1, y1), (x2, y2)], fill="#BB8800", width=grosor_linea)

        # Dibujar nodos intermedios
        for nodo in ruta[1:-1]:
            px, py = a_pixeles(pos[nodo][0], pos[nodo][1])
            draw.ellipse([(px - radio_int, py - radio_int), (px + radio_int, py + radio_int)], fill="white", outline="#002B7A", width=grosor_borde_int)
        ...
        # Dibujar Origen
        px_orig, py_orig = a_pixeles(pos[peticion.origen][0], pos[peticion.origen][1])
        draw.ellipse([(px_orig - radio_ext, py_orig - radio_ext), (px_orig + radio_ext, py_orig + radio_ext)], fill="#002B7A", outline="white", width=grosor_borde_ext)
